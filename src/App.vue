  ...
  <div class="workspace">
    <header class="menu-bar">
      <div class="menu-section">
        ...
        <button class="menu-btn" @click="showNewMap = true">新建</button>
        <button class="menu-btn" @click="openLibrary">地图库</button>
        <button class="menu-btn" @click="triggerImport">导入</button>
        <button class="menu-btn" @click="saveToLibrary(false)">保存地图</button>
        <button class="menu-btn" @click="saveToLibrary(true)">存为草稿</button>
        <button class="menu-btn" :disabled="busy" @click="exportMap">导出地图</button>
      </div>

      <div class="menu-section">
        <span class="menu-title">编辑</span>
        <button class="menu-btn" @click="store.resetMapData()">重置地图</button>
        <button class="menu-btn" @click="exportDevicesCsv">导出外设</button>
      </div>
      ...
      <div class="menu-section">
        ...
        <button
          class="menu-btn"
          :class="{ active: store.viewFlags.showNavBlock }"
    ...
    <section class="options-bar">
      ...
      <div class="options-fixed">
        <button class="menu-btn" @click="store.requestCenterView()">视图居中</button>
        <button class="menu-btn" :disabled="!store.canUndo" @click="store.undo()">撤销</button>
        <button class="menu-btn" :disabled="!store.canRedo" @click="store.redo()">重做</button>
        <button class="menu-btn" @click="checkPath">检查路径</button>
      </div>
    </section>
    ...
    <div class="app-shell">
      <aside class="toolbar">
        ...
        <div class="tool-stack">
          ...
          <button
            class="tool-btn"
            :class="{ active: store.activeTool === 'path-draw' }"
          ...
          <button
            class="tool-btn"
            :class="{ active: store.activeTool === 'path-erase' }"
          ...
          <button
            class="tool-btn"
            :class="{ active: store.activeTool === 'platform' }"
          ...
          <button
            class="tool-btn"
            :class="{ active: store.activeTool === 'charger' }"
          ...
          <button
            class="tool-btn"
            :class="{ active: store.activeTool === 'waiting' }"
      ...
      <aside class="prop-panel">
        ...
        <section class="section">
          ...
          <template v-else-if="store.selectedElement.kind === 'device' && store.singleSelectedDevice">
            ...
            <button class="menu-btn full" @click="applySingleProps">应用属性</button>
          </template>
    ...
    <div v-if="showNewMap" class="modal-mask" @click.self="showNewMap = false">
      <div class="modal">
        ...
        <div class="modal-actions">
          <button class="menu-btn" @click="showNewMap = false">取消</button>
          <button class="menu-btn active" @click="createMap">创建</button>
        </div>
      </div>
    </div>
    ...
    <div v-if="showLibrary" class="modal-mask" @click.self="showLibrary = false">
      <div class="modal large">
        ...
        <div class="library-toolbar">
          ...
          <button class="menu-btn" @click="deleteLibrarySelected">删除选中</button>
        </div>
        <div class="library-list">
          <div v-for="item in filteredLibrary" :key="item.id" class="library-item">
            ...
            <div class="library-actions">
              <button class="menu-btn" @click="openLibraryItem(item.id)">打开</button>
              <button class="menu-btn" @click="exportLibraryItem(item.id)">导出</button>
            </div>
          </div>
        </div>
      </div>
